...
{                                                                            \
     do_printf_sun(1,1,T0);                                                   \
    if((uint32_t)T0 >= 0xfff00000)                                           \
        (uint32_t)T0 = (uint32_t)T0 - 0xf8000000;                             \
    if(((uint32_t)T0 >= 0x8000000) && ((uint32_t)T0 < 0x0A000000))            \
         (uint32_t)T0 = (uint32_t)T0 - 0x1000000;                            \
