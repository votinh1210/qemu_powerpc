...
void OPPROTO op_store_vec_b(void)          //mari
{
   
     T2 = (int32_t)PARAM1;
     do_store_vector_b(T0,T1,T2);
     do_printf_vector(T2);  
     RETURN();
}
void OPPROTO op_store_vec_h(void)          //mari
{
     T2 = (int32_t)PARAM1;
     do_store_vector_h(T0,T1,T2);
     do_printf_vector(T2);  
     RETURN();
}
void OPPROTO op_store_vec_w(void)          //mari
{
     T2 = (int32_t)PARAM1;
     do_store_vector_w(T0,T1,T2);
     do_printf_vector(T2);  
     RETURN();
}
void OPPROTO op_init_vec_l(void)          //mari
{
     T2 = (int32_t)PARAM1;
     do_init_vec_l(T0,T2);
     do_printf_vector(T2);  
...
void OPPROTO op_init_vec_r(void)          //mari
{
     T2 = (int32_t)PARAM1;
     do_init_vec_r(T0,T2);
     do_printf_vector(T2);  
...
void OPPROTO op_load_vec_b(void)                  //mari
{
     T2 = (int32_t)PARAM1;
     T1 = do_load_vec_b(T0,T2); 
     RETURN();
}
void OPPROTO op_load_vec_h(void)                  //mari
{
     T2 = (int32_t)PARAM1;
     T0 = T0 & 0xfffffffe;
     T1 = do_load_vec_h(T0,T2); 
     RETURN();
}
void OPPROTO op_load_vec_w(void)                  //mari
{
     T2 = (int32_t)PARAM1;
     T0 = T0 & 0xfffffffc;
     T1 = do_load_vec_w(T0,T2); 
     RETURN();
}
void OPPROTO op_printf_mem_s(void)
{
    do_printf_mem_s(T0);
}
...
void OPPROTO op_word_sun_T0(void)          //mari
{
    T0 = T0 & 0xfffffff0;
    RETURN();
}
...
{
  //  T0 = cpu_ppc_load_tbl(env);        //mari
    RETURN();
}

void OPPROTO op_load_tbu (void)
{
    //T0 = cpu_ppc_load_tbu(env);         //mari
    RETURN();
}

void OPPROTO op_load_atbl (void)
{
   // T0 = cpu_ppc_load_atbl(env);        //mari
    RETURN();
}

void OPPROTO op_load_atbu (void)
{
   // T0 = cpu_ppc_load_atbu(env);        //mari
    RETURN();
}
...
{
    //cpu_ppc_store_tbl(env, T0);                    //mari
    RETURN();
}

void OPPROTO op_store_tbu (void)
{
    //cpu_ppc_store_tbu(env, T0);                //mari
    RETURN();
}

void OPPROTO op_store_atbl (void)
{
   // cpu_ppc_store_atbl(env, T0);             //mari
    RETURN();
}

void OPPROTO op_store_atbu (void)
{
    //cpu_ppc_store_atbu(env, T0);              //mari
    RETURN();
}

void OPPROTO op_load_decr (void)
{
    //T0 = cpu_ppc_load_decr(env);               //mari
    RETURN();
}

void OPPROTO op_store_decr (void)
{
   // cpu_ppc_store_decr(env, T0);              //mari
    RETURN();
}
...
/* divide word */
void OPPROTO op_divw (void)                                                         //mari
{
...
{
   // T0 = cpu_ppc601_load_rtcl(env);                      //mari
    RETURN();
}

void OPPROTO op_load_601_rtcu (void)
{
   // T0 = cpu_ppc601_load_rtcu(env);                    //mari
    RETURN();
}
...
{
    //cpu_ppc601_store_rtcl(env, T0);                     //mari
    RETURN();
}

void OPPROTO op_store_601_rtcu (void)
{
    //cpu_ppc601_store_rtcu(env, T0);                        //mari
    RETURN();
}
...
{
    //T0 = load_40x_pit(env);                               //mari
    RETURN();
}

void OPPROTO op_store_40x_pit (void)
{
   // store_40x_pit(env, T0);                      //$$mari
    RETURN();
}
