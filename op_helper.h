...
/*kuozhanzhiling*/             //mari
void do_printf_sun(int c,int j,int i);
void do_print_xx(int i,int j,int k);
void do_store_vector_b(int addr, int data ,int i);
void do_store_vector_h(int addr, int data ,int i);
void do_store_vector_w(int addr, int data ,int i);
int do_load_vec_b(int addr , int i);
int do_load_vec_h(int addr , int i);
int do_load_vec_w(int addr , int i);
void do_printf_mem_s(int addr);
void do_init_vec_l(int addr ,int j);
void do_init_vec_r(int addr ,int j);
void do_printf_vector(int i);
